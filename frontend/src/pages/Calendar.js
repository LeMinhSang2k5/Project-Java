...
const Calendar = () => {
                ...
                <div className="cusContrainer">
                    ...
                    <div className="listTabs">
                        <div className="Tabscontent ">
                            <div className={`iteamTabs ${selectedTab === 'lichTongQuat' ? 'active-tab' : ''}`}
 onClick={() => setSelectedTab('lichTongQuat')}>
                                <p className="tabs" >Lịch tổng quát</p>
                            </div>
                            <div className="icon_img">
                                <img src={nextIcon} alt="next icon" />
                            </div>
                            <div className={`iteamTabs ${selectedTab === '17_19' ? 'active-tab' : ''}`}
 onClick={() => setSelectedTab('17_19')}>
                            ...
                            <div className={`iteamTabs ${selectedTab === '19_49' ? 'active-tab' : ''}`} onClick={() => setSelectedTab('19_49')}>
                                <p className="tabs">19-49</p>
                            </div>
                            <div className="icon_img">
                                <img src={nextIcon} alt="next icon" />
                            </div>
                            <div  className={`iteamTabs ${selectedTab === 'dacBiet' ? 'active-tab' : ''}`} onClick={() => setSelectedTab('dacBiet')}>
            ...
            <div className="tableContent">
                <table >
                    ...
                    <tr>
                        ...
                        </td><td rowspan="6" className="background_vac-xin">
                            <div className="vac-xin">
                                <span>Vắc xin 6 trong 1</span>
                            </div>
                        </td><td className="background_null">
                            <div>
                            </div>
                        </td><td rowspan="6" className="background_hits">
                            <div className="hits">
                                <span>Mũi 4</span>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                                <span>
                                    Lựa chọn 1: VNNB bất hoạt từ não chuột
                                </span>
                            </div>
                        </td>
                        <td className="background_null">
                    ...
                    <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                                <span>
                                    Lựa chọn 3: VNNB sống giảm độc lực, tái tổ hợp
                                </span>
                            </div>
                        </td>
                        <td className="background_null">
                        ...
                        <td className="background_hits">
                            <div className="hits">
                                <span>1 Mũi nhắc
                                    (tốt nhất 1-2 năm sau mũi đầu tiên)
                                </span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colSpan="3" className="background_hits">
                            <div className="hits">
                                <p><strong>Mũi 2</strong>"-Cách mũi 1 ít nhất 4 tuần"</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>2 Mũi</strong>-cách nhau 3 tháng</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                        <td className="background_hits">
                            <div className="hits">
                                <p>Từ 2 tuổi trở lên <strong>1 Mũi</strong>-tiêm nhắc cho nhóm  nguy cơ cao </p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colSpan="3" className="background_hits">
                            <div className="hits">
                                <p>Tiêm cúm lần đầu:<strong>2 Mũi</strong>-cách nhau ít nhất 4 tuần tiêm hằng năm</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="3" className="background_hits">
                            <div className="hits">
                                <p><strong>Mũi 2</strong>-cách mũi 1 từ 6 tuần- 3 tháng, tùy loại vắc xin</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                                Viêm gan A đơn giá/ phối hợp
                            </div>
                        </td>
                        <td colSpan="3" className="background_hits">
                            <div className="hits">
                                <p><strong>2 Mũi</strong>-cách nhau 6-12 tháng</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="3" className="background_hits">
                            <div className="hits">
                                <p><strong>5 Mũi tiêm bắp </strong>hoặc 8 liều (4 ngay) tiêm trong da sau phơi nhiễm, đã tiêm vắc xin dại trước đó :<strong>2 Mũi</strong></p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td className="background_hits">
                            <div className="hits">
                                <p><strong>2 liều uống</strong> cách nhau 14 ngày</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
const Table19_49Tuoi = () => {
               ...
               <table>
                <tr>
                    ...
                    <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                               Vắc xin Cúm bất hoạt IV4
                            </div>
                        </td>
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p>Tiêm chủng hàng năm<strong>1 Mũi</strong></p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                                Vắc-xin phối hợp 
 có chứa thành phần 
 Bạch hầu & Ho gà giảm liều
                            </div>
                        </td>
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>1 Mũi</strong>Tdap sau đó nhắc lại Tdap mỗi 10 năm</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                               VNNB 
 Bất hoạt tế bào Vero
                            </div>
                        </td>
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>Mũi 2</strong>cách nhau 28 ngày + 1 mũi (mũi 3) sau 1 năm</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
 ...
 Sống giảm độc lực
                      ...
                      <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>2 Mũi</strong> - cách nhau 1 tháng</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                     ...
                     <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>1 Mũi</strong>(tới 55 tuổi)</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>3 Mũi</strong> - 0,2,6 tháng -<strong>CẦN TEST TRƯỚC KHI TIÊM</strong> </p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td className="background_vac-xin">
                            <div className="vac-xin">
                               Vắc-xin Viêm gan A đơn giá 
hoặc Vắc-xin phối hợp 
ngừa VGA và VGB
                            </div>
                        </td>
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>VGA ĐƠN - 2 MŨI (0,6 THÁNG), VGA PHỐI HỢP - 3 MŨI (0,1,6 THÁNG)</strong></p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
 ...
 và các bệnh khác  do HPV
                        ...
                        <td className="background_hits">
                            <div className="hits">
                                <p><strong>3 Mũi</strong>- 0,2,6 tháng</p>
                            </div>
                        </td>
                        <td className="background_null">
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="2" className="background_supper">
                            <div className="supper">
                                <p><strong>5 MŨI TIÊN BẮP HOẶC 8 MŨI TIÊM (4 NGÀY 2 VỊ TRÍ) </strong>- sau phơi nhiễm. 
 Nếu đã tiêm vắc xin dại trước đó, tiêm 2 mũi ngày 0-3</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>1 Mũi</strong>- nhắc lại mỗi 3 năm nếu có phơi nhiễm</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td colSpan="2" className="background_hits">
                            <div className="hits">
                                <p><strong>1 Mũi</strong>- nhắc lại mỗi 10 năm nếu sống trong vùng dịch lưu hành</p>
                            </div>
                        </td>
                        <td hidden colspan="0" >
                        </td>
               ...
               <table>
                ...
                <tr>
                    ...
                    <td  className="background_cusCell">
                     ...
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                            <span>Thương hàn 1 mũi (Nhắc lại mỗi
3 năm nếu đi vào vùng dịch)</span>
                        </div>
                    </td>
                </tr>
                 <tr>
                 ...
                 <tr>
                    ...
                    <td  className="background_cusCell">
                        <div className="can_hits">
                            <span>Não mô cầu nhóm
 huyết thanh B</span>
                        </div>
                    </td>
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                            <span>Vắc xin não mô cầu nhóm B 
(4CMenB: 2 liều cách nhau 1 tháng)</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td  className="background_cusCell">
                     ...
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                            <span>Vắc-xin phối hợp ngừa các bệnh:
 Bạch hầu, Uốn ván, Ho gà, (Bại liệt)</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td  className="background_cusCell">
                        <div className="can_hits">
                            <span>Viêm màng não do
 Não mô cầu ACWY</span>
                        </div>
                    </td>
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td  className="background_cusCell">
                        <div className="can_hits">
                            <span>Viêm màng não do Não mô cầu
 ACWY ở thanh thiếu niên</span>
                        </div>
                    </td>
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                            <span>Não mô cầu A,C,Y,W-135
(1 mũi)</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td  className="background_cusCell">
                     ...
                     <td className="background_vac-xin" >
                        <div className="vac-xin" >
                            <span>Não mô cầu nhóm huyết thanh B
(4CMenB: 2 liều cách nhau 1 tháng)</span>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                       <td className="background_sicks">
                        ...
                        <td rowSpan={3} className="background_vac-xin">
                            <div className="vac-xin">Vắc-xin Uốn ván đơn/ 
Vắc-xin phối hợp ngừa 
Bạch hầu, Uốn ván, Ho gà 
/Vắc-xin phối hợp ngừa 
Bạch hầu, Uốn ván</div>
                        </td>
                </tr>
                <tr>
                       <td className="background_sicks">
